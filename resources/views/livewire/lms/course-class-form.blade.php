<form id="kt_account_profile_details_form" class="form" wire:submit.prevent="submit">
  ...
  <x-field-container>
    <div class="col">
      <x-text-field label="Name" name="courseClass.name" required="true"/>
    </div>
    <div class="col-sm-12 col-md-12">
      <x-text-field label="Name Alt" name="courseClass.name_alt" required="false"/>
    </div>
    ...
    {{--    </div>--}}
    <div class="col">
      <x-checkbox-field label="Free" name="courseClass.free" required="false"/>
    </div>

    <div class="col">
      <x-checkbox-field label="Inactive" name="courseClass.inactive" required="false"/>
    </div>
  </x-field-container>
