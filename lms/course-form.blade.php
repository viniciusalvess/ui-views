        ...
        <div class="accordion-body">
          <form id="kt_account_profile_details_form" class="form" wire:submit.prevent="submit">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12">
                <x-text-field label="Name Alt" name="course.name_alt" required="true"/>
              </div>
            ...
            <div class="row">
              <div class="col">
                <x-file-field name="picture" label="Picture" :pictureTemp="$picture" value="{{$course->picture}}"/>
              </div>
              <div class="col">
                <x-file-field name="video" label="Video" :pictureTemp="$video" value="{{$course->video}}"/>
              </div>
